                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'github.com/${controller.githubUsername}',
                        style: const TextStyle(
                            fontSize: 20, fontWeight: FontWeight.bold),
                      ),
                    ],
                    ...
                    (index) => Padding(
                          ...
                          child: ListTile(
                            title: Row(
                              children: [
                                Text(
                                  '${controller.experiences[index].companyName}:',
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                                xSpace(20),
                                Text(controller.experiences[index].position)
                              ],
                            ),
                            subtitle: Row(
                              children: [
                                ...
                                xSpace(20),
                                controller.experiences[index].durationInMonths >
                                        12
                                    ? Text(
                                ...
                                PopupMenuItem(
                                  onTap: () {
                                    ...
                                    ScaffoldMessenger.of(context)
                                      ...
                                      content: const Text('Expereince deleted'),
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                      ...
                      (index) => InkWell(
                            onLongPress: () {
                              String skill = controller.skills.elementAt(index);
